...
//     return true;
//   };
// const VITE_GOOGLE_LOGIN_API = import.meta.env.VITE_GOOGLE_LOGIN_API;
// const VITE_API_URL_LOGIN = import.meta.env.VITE_JOB_API_URL_LOGIN;
//   const handleSubmit = async (e) => {
//     e.preventDefault(); // Prevent default form submission
//     if (!validateForm()) return;

//     try {
//       const response = await axios.post(VITE_API_URL_LOGIN, {
...
//       try {
//         const response = await axios.post(VITE_GOOGLE_LOGIN_API, {
...
function Signin({ onClose, onSwitchToSignup }) {
  ...
  const VITE_API_URL_GOOGLE_LOGIN = import.meta.env.VITE_API_URL_GOOGLE_LOGIN;
  ...
  const handleGoogleLogin = async (credentialResponse) => {
    try {
      ...
      try {
        ...
        // Proceed with client-side data if backend fails
      }
  ...
  return (
    <div className="h-full bg-white flex flex-col p-4">
      <div className="bg-white w-full max-w-md h-full relative">
        ...
        <div className="pt-6 px-6 flex items-center gap-5">
          <h1 className="text-2xl font-bold text-[#1f8268] mb-2">Login</h1>
          <button
            onClick={onSwitchToSignup}
            className="text-[#1f8268] hover:text-blue-700 text-xl font-bold transition-colors"
          >
            Sign Up
          </button>
        </div>
